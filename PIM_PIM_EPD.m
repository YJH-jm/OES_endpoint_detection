...
PIM_p_end = 270;                                %예상 endpoint 지점 (etch rate에 계산된 예상 지점)
...
%%%%%%%%%% data size 맞추기 %%%%%%%%%%
data1 = oes_data1(5:PIM_p_end+60,:);
data2 = oes_data2(5:PIM_p_end+60,:);
data3 = oes_data3(5:PIM_p_end+60,:);
data4 = pim_data1(5:PIM_p_end+60,:);
data5 = pim_data2(5:PIM_p_end+60,:);
data6 = pim_data3(5:PIM_p_end+60,:);
...
OES_p_end = (mean2(PIM_EPD(2,:)))+PIM_p_end-50;
